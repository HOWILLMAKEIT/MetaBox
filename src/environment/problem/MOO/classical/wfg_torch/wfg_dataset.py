...
class WFG_Dataset(Dataset):
    ...
    def get_datasets(suit=None,
        ...
        return WFG_Dataset(train_set, train_batch_size), WFG_Dataset(test_set, test_batch_size)
    ...
    def __add__(self, other: 'WFG_Dataset'):
        return WFG_Dataset(self.data + other.data, self.batch_size)
