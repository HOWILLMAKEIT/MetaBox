...
class UF_Dataset(Dataset):
    ...
    def get_datasets(suit=None,
        ...
        return UF_Dataset(train_set, train_batch_size), UF_Dataset(test_set, test_batch_size)
    ...
    def __add__(self, other: 'UF_Dataset'):
        return UF_Dataset(self.data + other.data, self.batch_size)
