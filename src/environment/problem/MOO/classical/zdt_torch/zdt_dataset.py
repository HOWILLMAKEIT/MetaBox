...
class ZDT_Dataset(Dataset):
    ...
    def get_datasets(suit=None,
        ...
        return ZDT_Dataset(train_set, train_batch_size), ZDT_Dataset(test_set, test_batch_size)
    ...
    def __add__(self, other: 'ZDT_Dataset'):
        return ZDT_Dataset(self.data + other.data, self.batch_size)
