...
import numpy as np
from problem.MOO.classical.dtlz_numpy.dtlz import DTLZ1, DTLZ2, DTLZ3, DTLZ4, DTLZ5, DTLZ6, DTLZ7

class DTLZ_Dataset(Dataset):
    def __init__(self,
                 data,
                 batch_size=1):
        super().__init__()
    ...
    def get_datasets(suit=None,
        ...
        return DTLZ_Dataset(train_set, train_batch_size), DTLZ_Dataset(test_set, test_batch_size)
    ...
    def __add__(self, other: 'DTLZ_Dataset'):
        return DTLZ_Dataset(self.data + other.data, self.batch_size)
