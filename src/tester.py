...
class Tester(object):
    ...
    def mte_test(self, agent: str, pre_train_problem: str, pre_train_difficulty: str, pre_train_data_path: str, scratch_data_path: str, pdf_fig: bool = True):
        """
        # Introduction
        ...
        mte_test_log_dir = f"{self.mte_test_log_dir}/{agent}"
