...
class Tester(object):
    def __init__(self, config):
        ...
        '''
        # cost 间隔多少FEs的最优
        {'cost': {problem1: {agent1: [cost1, cost2, ...], agent2: [cost1, cost2, ...]}, 
                  problem2: {agent1: [cost1, cost2, ...], agent2: [cost1, cost2, ...]}},
         'fes': {problem1: {agent1: [fes1, fes2, ...], agent2: [fes1, fes2, ...]},
                                           51

        {'metadata': {problem1: {agent1: [metadata1, metadata2, ...], agent2: [metadata1, metadata2, ...]},
                                                   51
        '''
    ...
    def test_3(self):
        ...
        with tqdm(range(pbar_len), desc = "Testing") as pbar:
            for i, problem in enumerate(self.test_set):
                ...
                #[{'cost': cost, 'fes': fes, 'return': R},{'cost': cost, 'fes': fes, 'return': R}]
                # 处理一下 传到到test result 
                pbar_info = {'Testing': "MetaBBO",
                             }
                pbar.set_postfix(pbar_info)
