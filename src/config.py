...
def get_config(args=None):
    ...
    # Common config
    parser.add_argument('--problem', default='bbob', choices=['Symbolic_bench','Symbolic_bench-torch','bbob', 'bbob-noisy', 'bbob-torch', 'bbob-noisy-torch', 'protein', 'protein-torch'],
