...
| upperbound     讨论一下                 | Upperbound of search space, which is designed for BBOB and HPO-B to set the problems                                           | float value                                                                                                                       | 5     |                                                                                                                      
...
| parallel_batch                  | The parallel processing mode for testing                               | ['Full', 'Baseline_Problem', 'Problem_Testrun', 'Batch'，'Seriral']                                                                          | 'Batch'                                                                                                                       |
